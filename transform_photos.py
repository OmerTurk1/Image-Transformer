...
if __name__ == "__main__":
    source_photo_name = "fatihterim.png"
    target_photo_name = "ijwbpoys.jpg"

    org_photos_folder = "photos/original/"
    res_photos_folder = "photos/results/"

    source = f"{org_photos_folder}{source_photo_name}"
    target = f"{org_photos_folder}{target_photo_name}"
    ...
    result_img_name = f"{res_photos_folder}{source_photo_name.split('.')[0]}_to_{target_photo_name.split('.')[0]}.png"
    result_img.save(result_img_name)
    print(f"{target_photo_name} image is transformed into {source_photo_name}, creating {result_img_name}")